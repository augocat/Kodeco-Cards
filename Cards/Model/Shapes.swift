...
//  Cards
//
//  Created by Grahame Narborough on 1/6/2024.
//

import SwiftUI

struct Shapes_Previews: PreviewProvider {
    static let currentShape = Diamond()
...
//struct RoundedSquare_b: Shape {
//  func path(in rect: CGRect) -> Path {
//    var path = Path()
////      path.move(to: CGPoint(x: 0, y: 0))
//      path.addRoundedRect(in: rect, cornerSize: rect * 0.5, style: .circular)
